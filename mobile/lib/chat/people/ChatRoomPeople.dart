...
class ChatRoomPeople extends StatefulWidget {
  @override
  _ChatRoomPeopleState createState() => _ChatRoomPeopleState();
}

class _ChatRoomPeopleState extends State<ChatRoomPeople> {
